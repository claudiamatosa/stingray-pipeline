...
// Santa
$('<style type="text/css">body { background: white url("http://growingroomchildcare.com/wp-content/uploads/2013/12/Santa-Claus-Sleigh.jpg") no-repeat center bottom; background-size: 30%; }</style>').appendTo($('head'));