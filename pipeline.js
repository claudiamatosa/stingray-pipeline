...
// Fire!!
$('<style type="text/css">.fail-holder .testbox .date { background: url("http://www.gifandgif.eu/animated_gif/Fire/Animated%20Gif%20Fire%20%28104%29.gif") no-repeat center 48px; }</style>').appendTo($('head'));